    ...
    <div className="bg-white h-auto grid content-center grid-cols-2  py-24">
      <div className="">
        <img
          ...
          className="w-11/12 left-40 relative h-full object-cover transition-transform duration-300 transform hover:scale-110"
          alt=""
        />
      </div>
      <div className="right-28  p-10 bg-white mt-6 w-11/12  me-30 z-50 relative flex justify-center flex-col h-[90%] border border-gold">
        ...
        <h2 className="text-4xl font-GildaDisplay py-3">Double Room</h2>
        <p className="text-offWhite">
        ...
        <div className="grid my-5 text-offWhite grid-cols-3 gap-6">
          <div className="flex items-center">
            ...
            <p className="ps-2">2 Person</p>
          </div>
          <div className="flex items-center">
            <PiBedThin className="text-gold text-2xl" />
            <p className="ps-2">1 Twin Bed</p>
          </div>
          <div className="flex items-center">
            <PiHouseLineThin className="text-gold text-2xl" />
            <p className="ps-2">250 sqt Room</p>
          </div>
          <div className="flex items-center">
